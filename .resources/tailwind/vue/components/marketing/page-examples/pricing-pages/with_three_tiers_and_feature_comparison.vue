  ...
  <div class="bg-gray-50">
    ...
    <main>
      ...
      <div>
        ...
        <!-- Feature comparison -->
        <section aria-labelledby="mobileComparisonHeading" class="lg:hidden">
          <h2 id="mobileComparisonHeading" class="sr-only">Feature comparison</h2>

          <div class="mt-16 max-w-2xl mx-auto px-4 space-y-16 sm:px-6">
            <div v-for="plan in plans" :key="plan.title" class="border-t border-gray-200">
        ...
        <section aria-labelledby="comparisonHeading" class="hidden lg:block">
          <h2 id="comparisonHeading" class="sr-only">Feature comparison</h2>
          ...
          <div class="mt-24 max-w-7xl mx-auto px-8">
            <div class="w-full border-t border-gray-200 flex items-stretch">
              ...
              <div v-for="plan in plans" :key="plan.title" aria-hidden="true" :class="[index === plans.length - 1 ? '' : 'pr-4', '-mt-px pl-4 w-1/4']">
              ...
              <table class="relative w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                  <tr v-for="(feature, featureIndex) in features" :key="featureIndex">
                    ...
                    <td v-for="tier in feature.tiers" :key="tier.title" :class="[index === feature.tiers.length - 1 ? 'pl-4' : 'px-4', 'relative w-1/4 py-0 text-center']">
              ...
              <table class="relative w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                  <tr v-for="perk in perks" :key="perk.title">
                    ...
                    <td v-for="tier in perk.tiers" :key="tier.title" :class="[index === perk.tiers.length - 1 ? 'pl-4' : 'px-4', 'relative w-1/4 py-0 text-center']">
                      <span class="relative w-full h-full py-3">
                        <CheckIcon v-if="tier.value === true" class="mx-auto h-5 w-5 text-indigo-600" aria-hidden="true" />
                        <XIcon v-else class="mx-auto h-5 w-5 text-gray-400" aria-hidden="true" />
                        <span class="sr-only">{{ tier.value === true ? 'Yes' : 'No' }}</span>
      ...
      <!-- FAQs -->
      <section aria-labelledby="faqHeading" class="bg-gray-900">
        <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="max-w-2xl lg:mx-auto lg:text-center">
            <h2 id="faqHeading" class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
              <img class="h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=indigo&shade=600" alt="Company name" />
              <p class="text-gray-500 text-base">
                Making the world a better place through constructing elegant hierarchies.
              </p>
              <div class="flex space-x-6">
                <a v-for="socialLink in footerNavigation.social" :key="socialLink.name" :href="socialLink.href" class="text-gray-400 hover:text-gray-500">
                  <span class="sr-only">{{ socialLink.name }}</span>
                  <component :is="socialLink.icon" class="h-6 w-6" aria-hidden="true" />
                </a>
              </div>
            </div>
            <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 class="text-sm font-semibold tracking-wider uppercase text-gray-900">
                    Solutions
                  </h3>
                  <ul class="mt-4 space-y-4">
                    <li v-for="link in footerNavigation.solutions" :key="link.name">
                ...
                <div class="mt-12 md:mt-0">
                  ...
                  <ul class="mt-4 space-y-4">
                    <li v-for="link in footerNavigation.support" :key="link.name">
                      <a :href="link.href" class="text-base text-gray-500 hover:text-gray-900">
                        {{ link.name }}
                      </a>
                    </li>
              ...
              <div class="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div class="mt-12 md:mt-0">
                  ...
                  <ul class="mt-4 space-y-4">
                    <li v-for="link in footerNavigation.legal" :key="link.name">
                      <a :href="link.href" class="text-base text-gray-500 hover:text-gray-900">
                        {{ link.name }}
                      </a>
                    </li>
